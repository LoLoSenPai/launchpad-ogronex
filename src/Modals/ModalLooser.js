    ...
    return (
        ...
        >
            ...
            >
                ...
                <h1 className='text-gray-400 text-2xl font-bold mb-4'>Modal Looser</h1>
                <p className='text-gray-400'>Bummer, you didn't snag an NFT this time. But remember, in the world of blockchain, every 'no' is just a 'not yet.' Head over to the secondary market and grab your NFT. Who knows, you might even find a diamond in the rough!</p>
            </div>
        </div>
    )
}
