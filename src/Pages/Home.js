...
export default function Home() {
  ...
  const handleClick = () => {
    ...
    // Faire disparaître les feux d'artifice après 5 secondes
    setTimeout(() => {
    ...
    <>
      <div className="homepage py-10 px-20 md:px-40 lg:px-60">
        ...
        <div className="relative">
            ...
            <div className="flex flex-row justify-center">
              ...
              <div className="flex flex-col mt-10 max-w-[700px] gap-6">
                ...
                <div className="flex flew-row gap-11 w-full justify-between">
                  ...
                  <button
                    className="w-2/4 h-14 rounded-lg text-2xl bg-light font-bold text-black"
                    onClick={() => handleClick()}
                  >
                    Buy Tickets
                  </button>
          ...
          {showFireworks && <Fireworks className="absolute z-20 right-0" />}
        </div>
      </div>
